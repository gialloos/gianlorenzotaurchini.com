...
Costruito in Flutter con un database di giocatori incluso, è pensato per le serate tra amici. Nessuna pubblicità, nessun tracciamento, nessun dato che lascia il dispositivo; italiano e inglese.`,
    description_en: `Undici is a football game to play together: fast, offline and without an account.
Built in Flutter with a bundled players database, it's made for nights out with friends. No ads, no tracking, no data leaving the device; Italian and English.`,
    features_it: [
      '100% offline, senza account',
      'Database di giocatori incluso',
      'Niente pubblicità né tracciamento',
      'Statistiche salvate solo sul dispositivo',
      'Italiano e inglese',
    ],
    features_en: [
      '100% offline, no account',
      'Bundled players database',
      'No ads or tracking',
      'Stats stored only on device',
      'Italian and English',
    ],
    website: '/undici/',
    appStore: null,
...
Realizzato in Flutter con un database di giocatori incluso. Nessuna pubblicità, nessun tracciamento, nessun dato raccolto; italiano e inglese.`,
    description_en: `Chi È? is a football party game where you guess the player: fast, offline and without an account.
Built in Flutter with a bundled players database. No ads, no tracking, no data collected; Italian and English.`,
    features_it: [
      '100% offline, senza account',
...
Sviluppato in Flutter con un database di giocatori incluso. Nessuna pubblicità, nessun tracciamento, nessun dato che lascia il dispositivo; italiano e inglese.`,
    description_en: `Incrocio is a football game where you find the player at the crossing of two criteria: fast, offline and without an account.
Built in Flutter with a bundled players database. No ads, no tracking, no data leaving the device; Italian and English.`,
    features_it: [
      '100% offline, senza account',
      'Trova il giocatore all\'incrocio',
      'Database di giocatori incluso',
      'Niente pubblicità né tracciamento',
      'Italiano e inglese',
    ],
    features_en: [
      '100% offline, no account',
      'Find the player at the crossing',
      'Bundled players database',
      'No ads or tracking',
      'Italian and English',
    ],
